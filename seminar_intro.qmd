...
**Examples of workflows combining AB and brightway**

<div>

```{=html}
<iframe class="slide-deck" height="300" width="500" style="border:2px solid black;" src="presentations/presentation_seminar_intro_examples.html"></iframe>
```

</div>

> [**Link to the slides**](presentations/presentation_seminar_intro_examples.html)
